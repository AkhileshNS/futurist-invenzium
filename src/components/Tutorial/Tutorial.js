...
const Tutorial = (props) => {
    ...
    return (
        <div className={cssClassName}>
            <p className={`${cssClassName}title`}>Using Custom Service Worker with Create-React-App</p>
            <p className={`${cssClassName}subtext`}>This site is not a tutorial on how to create PWA's. That said we thought we could include a 
...
you have worked with PWAs before and you are looking for a way to do the same with React, other readers should just continue down</p>
            <p className={`${cssClassName}subtext`}>If you are using the React framework to create a progressive web app, you will soon realise that 
...
module.exports = {
    ...
    plugins: [
        ...
        new SWPrecacheWebpackPlugin({
            ...
            />
            <p className={`${cssClassName}subtext`}>P.S: All these changes exist inside your node_modules. Therefore if you ever reinstall your node_modules folder, you will have to repeat these steps</p>
